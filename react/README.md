1. npm install sass@latest --save-dev
2. чтобы начать следить за изменениями в SCSS-файлах
   npm run watch:css

npm build:css

3. npm install normalize.css
4. Для разработки с Vite
   npm run dev
5. Для установки библиотек роутера
   npm install react-router
6. Очистка кэша
   rm -rf node_modules/.vite
7. Сохранение структуры проекта в файл
